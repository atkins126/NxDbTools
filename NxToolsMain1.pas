...
type
  ...
  Tfrm_NxToolsMain = class(TForm)
    ...
    lbl_1: TLabel;
    lbl_AliasLabel: TLabel;
    lbl_11: TLabel;
    lbl_ServersLabel: TLabel;
    lbl_12: TLabel;
    lbl_13: TLabel;
    lbl_14: TLabel;
    lst_TablesListBox: TListBox;
    lst_AliasListBox: TListBox;
    lst_ServerListBox: TListBox;
    btn_SQLChachedBtn: TJvXPButton;
    ts_SQLCommands: TTabSheet;
    pgc_SQLCommandsTab: TPageControl;
    ts_SQLStatementsFunctions: TTabSheet;
    ...
    btn_All: TButton;
    btn_Any: TButton;
    ts_SQLFunctionsTabSheet: TTabSheet;
    btn_Med: TButton;
    btn_Std: TButton;
    btn_List: TButton;
    ...
    gmrw_MoveTableSQLarrowbtn: TgemArrow;
    gmrw_MoveFieldNameSQLArrowbtn: TgemArrow;
    lbl_15: TLabel;
    lbl_16: TLabel;
    gmshpbtn_MasterDataSourceAddShapeBtn: TgemShapeBtn;
    lbl_17: TLabel;
    lst_TablesLB: TListBox;
    lst_FieldsLB: TListBox;
    ...
    pnl_SQLStatementsFuntions: TPanel;
